...
function init_skeleton()
    ...
    for _, bone in ipairs(spine) do s:add_bone(bone) end
    s:add_bone(head)
    for _, bone in ipairs(left_arm) do s:add_bone(bone) end
    for _, bone in ipairs(right_arm) do s:add_bone(bone) end
    for _, bone in ipairs(left_leg) do s:add_bone(bone) end
    for _, bone in ipairs(right_leg) do s:add_bone(bone) end
